    ...
    <footer className="bg-black text-white py-12 px-6">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">TREDDY</h3>
            <p className="text-gray-400 mb-4">
              Desenvolvimento de sites profissionais que impulsionam o sucesso do seu negócio.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Otimização SEO</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Manutenção de Sites</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-start">
                ...
                <span>contato@treddy.com.br</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Treddy. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
